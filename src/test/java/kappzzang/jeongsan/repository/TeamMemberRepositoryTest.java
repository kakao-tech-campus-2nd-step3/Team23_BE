...
//
//        member1 = new Member(1L, "user1", "nickname1", "profile1", "token1", kakaoPayInfo, List.of(new TeamMember()));
//        member2 = new Member(2L, "user2", "nickname2", "profile2", "token2", kakaoPayInfo, List.of(new TeamMember()));
